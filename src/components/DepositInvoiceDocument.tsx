...
export interface DepositInvoiceLinePreview {
  name: string;
  description: string;
  qty: string;
  rate: string;
...
export interface DepositInvoicePreviewModel {
  ...
  paymentTerms: string;
  date: string;
  items: DepositInvoiceLinePreview[];
  message: string;
...
export const DEFAULT_DEPOSIT_INVOICE_PREVIEW: DepositInvoicePreviewModel = {
  companyAddressLines: [
...
export default function DepositInvoiceDocument({
  model = DEFAULT_DEPOSIT_INVOICE_PREVIEW,
  style = DEFAULT_QUOTATION_STYLE,
  printMode = false,
}: {
  model?: DepositInvoicePreviewModel;
