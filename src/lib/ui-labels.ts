...
export const BTN = {
  ...
  confirmEntry: bi('Link Payment', '連結付款'),
  linkToOrder: bi('Link to order', '連結此訂單'),
  unlink: bi('Unlink', '取消連結'),
